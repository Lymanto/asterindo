...
@section('title','Print Tanda Terima Barang')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <button class="btn btn-primary asli" style="background-color:#4a47a3;border-color:#4a47a3;">Asli</button>
                <button class="btn btn-primary copy" style="background-color:#fd5e53;border-color:#fd5e53;">Copy</button>
                <button class="btn btn-primary arsip" style="background-color:#007944;border-color:#007944;">Arsip</button>
                <button class="btn btn-warning reset">Reset</button>
                <a class="btn btn-danger ml-5" href="/list/tanda-terima-barang">Close</a>
            </div>
        </div>
    </div>
@endsection
...
@section('js')
    <script>
        $('.asli').on('click',function(){
            let isi = '<div class="row">';
                isi += '<div class="offset-11 col-1 text-center p-0" style="border:#4a47a3 solid;">'
                isi += '<span style="font-size:25px;color:#4a47a3;"><b>ASLI</b></span>'
                isi += '</div>'
            isi += '</div>'
            $('.jenis').html(isi);
        });
        $('.copy').on('click',function(){
            let isi = '<div class="row">';
                isi += '<div class="offset-11 col-1 text-center p-0" style="border:#fd5e53 solid;">'
                isi += '<span style="font-size:25px;color:#fd5e53;"><b>COPY</b></span>'
                isi += '</div>'
            isi += '</div>'
            $('.jenis').html(isi);
        });
        $('.arsip').on('click',function(){
            let isi = '<div class="row">';
                isi += '<div class="offset-11 col-1 text-center p-0" style="border:#007944 solid;">'
                isi += '<span style="font-size:25px;color:#007944;"><b>ARSIP</b></span>'
                isi += '</div>'
            isi += '</div>'
            $('.jenis').html(isi);
        });
