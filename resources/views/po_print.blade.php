                    ...
                    <tbody>
                        <tr>
                            <td>
                                        ...
                                        <table border="1" width="100%">
                                            <thead>
                                                ...
                                                <tr id="{{ $loop->iteration }}">
                                                    ...
                                                    <td class="text-nowrap text-right">{{ "Rp " . number_format($b->harga) }}</td>
                                ...
                                <!-- <div class="row">
                                    <div class="col-5 offset-7 d-flex flex-row">
                                        <span><b>GRAND TOTAL</b></span>
                                        <span class="ml-5">{{ "Rp " . number_format($grandtotal) }}</span>
                                    </div>
                                </div> -->
                            </td>
                        </tr>
